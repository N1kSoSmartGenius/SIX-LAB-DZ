...
class Calculator(QWidget):
    ...
    def _operation(self, op):
        ...
        self.input.setText("")
    def _result(self):
            if self.input.text().isnumeric() == False and ('?' or '!' or ';' or ':' or ',') not in self.input.text() and ".." not in self.input.text():
                ...
                self.input.setText("")
            elif self.input.text().isnumeric() == False and ('?' or '!' or ';' or ':' or ',') not in self.input.text() and ".." in self.input.text():
                ...
                if "." in self.input.text() and ".." not in self.input.text():
                    ...
                    if self.op == "+":
                        ...
                        if type(self.num_1 * self.num_2) == int:
                            self.input.setText(str((self.num_1*self.num_2)))
                        elif type(self.num_1 * self.num_2) == float and (self.num_1 * self.num_2) == int(self.num_1 * self.num_2):
